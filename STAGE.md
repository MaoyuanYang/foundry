...
| Field | Value |
| --- | --- |
| Snapshot Revision | `STAGE-0026` |
| Parent Snapshot | `STAGE-0025 / sha256:5B65A9DFFFDF4570EAA7D9398B4523D012714C55AC4A723F06F44366A354178A` |
| Last Reconciled At | `2026-09-01T16:19:28+08:00` |
| Reconciled By | `ZCode` |
| Repository Ref | `main@048b632` |
...
| Landing page five-Skill alignment (A-009) | `COMPLETE` | Commit `main@048b632` verified by `npm run docs:build` and `npm run skills:verify` (117/117); rendered EN/ZH landing pages contain the new copy | Preserve current behavior while extending the artifact contract |
...
|---|---|---|---|---|---|---|---|
| `A-009` | `Align Landing page copy with the five-Skill contract (ADR-0002)` | `ZCode` | Landing pipeline now shows all five Skills (auto-fit grid), the Gated Workflow card enumerates all seven Gates, and Quick Start adds evolution and maintenance prompts in both EN/ZH dictionaries | `DONE` | `STAGE_LOCAL:A-009` | Commit `048b632` on main; verified by `npm run docs:build` (rendered EN/ZH landing contains the new copy) and `npm run skills:verify` (117/117) | `2026-09-01T16:19:28+08:00` |
